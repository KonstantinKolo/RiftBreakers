...
- **Space** – Jump
- **Left Click** – Attack  
- **Right Click** – Change camera mode / Zoom
- **Shift** – Sprint  
- **Mouse** – Camera  

## How to Play
Download the corresponding .zip file for you OS, unzip it and run the file
## How to Develop 
1. Clone the repo:  
   ```bash
   git clone https://github.com/KonstantinKolo/RiftBreakers
